...
const Orders = () => {
    ...
    try {
      ...
      if (Array.isArray(data)) {
        const filteredOrders = data.filter(
          (order) => order.ordered_person_id === userId
        );
  ...
  const renderOrderItem = ({ item }) => {
    const restaurant = restaurants.find(
      (rest) => rest.restaurant_id === item.admin_id
    );
    ...
    return (
      <View style={styles.card}>
        ...
        <View style={styles.orderDetails}>
          ...
          />
          <DetailRow icon="call-outline" text={`Phone: ${item.phone_number}`} />
          <DetailRow icon="cash-outline" text={`Amount: ₹${item.amount}`} />
          ...
          <DetailRow icon="key-outline" text={`OTP: ${item.otp}`} />
        </View>
  ...
  const LoadingComponent = () => (
    <View style={styles.loaderContainer}>
      <View style={styles.loaderCircle}>
        <LottieView
          source={require("../assets/orders.json")}
          autoPlay
          loop
          style={styles.lottie}
        />
  ...
  //   <View style={styles.container}>
  //     {!loading && <Text style={styles.headerTitle}>Orders</Text>}
